...
python -m regulatory_lm.evals.modisco_predict_probs --peak_file $peak_file --model_dir $model_dir --checkpoint $checkpoint --out_dir $out_dir --data_format $data_format
