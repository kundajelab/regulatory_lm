...
modisco report -i modisco_results.h5 -o report/ -s report/ -m /oak/stanford/groups/akundaje/arpitas/dart-eval/task_2_footprinting/input_data/H12CORE_meme_format.meme